"""
Django settings for weathered_tooth_42204 project.
...
ROOT_URLCONF = 'weathered_tooth_42204.urls'
...
WSGI_APPLICATION = 'weathered_tooth_42204.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "weathered_tooth_42204 API",
    "DESCRIPTION": "API documentation for weathered_tooth_42204 App",
    "VERSION": "v1",
}
